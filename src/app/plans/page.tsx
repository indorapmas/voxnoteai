...
const plans = [
  ...
  },
  {
    ...
    price: 12,
    minutes: 600,
    features: ["600 min/month", "AI summaries", "Unlimited history", "PDF export"],
  ...
  },
  {
    ...
    price: 25,
    minutes: 1800,
    features: ["1,800 min/month", "AI summaries", "Unlimited history", "PDF + Notion export", "Priority processing"],
    cta: "Upgrade to Pro",
    popular: true,
  },
  {
    ...
    price: 59,
    minutes: 6000,
    features: ["6,000 min/month", "Everything in Pro", "5 team members", "Admin dashboard"],
