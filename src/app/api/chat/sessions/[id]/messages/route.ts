...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const stream = await anthropic.messages.create({
    ...
    max_tokens: 2048,
    system: "You are a helpful AI assistant. You can analyze images, videos (via transcripts or Gemini analysis), and answer any questions. Be clear, concise, and format responses with markdown when helpful.",
